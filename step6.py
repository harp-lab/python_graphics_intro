...
class Ball:
    ...
    def simulate(self):
        ...
        # simulate gravity at the center of the screen by accelerating balls toward this point
        # First, compute the angle to the center of the screen
        angle = math.atan2(height/2-self.y, width/2-self.x)
        # apply (constant) acceleration in this direction
        mag = 0.005
        self.xv += mag*math.cos(angle)
        self.yv += mag*math.sin(angle)
